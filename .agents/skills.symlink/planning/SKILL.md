...
4. If the user opt-in to create a ticket, use the Question tool to ask the
   following questions:
...
5. If the following choices were selected, do not specify their corresponding
   option when calling the CLI:
   - Points: unpointed
   - Sprint: backlog
   - Assgnee: unassigned.
6. Create ticket.
