...
-- Close buffers
vim.keymap.set('n', '<leader>q', ':close <CR>', { desc = '[B]uffer [q]uit' })
vim.keymap.set('n', '<leader>w', ':tabclose <CR>', { desc = '[B]uffer close a[l]l' })
-- [[ Basic Autocommands ]]
...
require('lazy').setup({
  ...
  -- repo, not just copy pasted the
  -- init.lua. If you want these files, they are in the repository, so you can
  -- just download them and
