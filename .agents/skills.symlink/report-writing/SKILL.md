...
1. Write report under `,reports/<brainstorm|failure>/`, where the comma prefix is mandatory.
2. Report filenames shall be kebab-case with the following pattern: YYYY-MM-DD-<change-name>.
